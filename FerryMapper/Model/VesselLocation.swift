...
@Model
final class VesselLocation: Sendable, Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.arrivingTerminalID = try container.decodeIfPresent(Int.self, forKey: .arrivingTerminalID)
        self.arrivingTerminalName = try container.decodeIfPresent(String.self, forKey: .arrivingTerminalName)
        self.arrivingTerminalAbbrev = try container.decodeIfPresent(String.self, forKey: .arrivingTerminalAbbrev)
        ...
        self.etaBasis = try container.decodeIfPresent(String.self, forKey: .etaBasis)
        ...
        self.vesselPositionNum = try container.decodeIfPresent(Int.self, forKey: .vesselPositionNum)
